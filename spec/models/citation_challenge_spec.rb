...
RSpec.describe CitationChallenge, type: :model do
  ...
  describe "factory" do
    it "is valid" do
      citation_challenge = FactoryBot.create(:citation_challenge_approved)
      expect(citation_challenge.hypothesis_citation).to be_present
      expect(citation_challenge.citation).to be_present
      expect(citation_challenge.approved?).to be_truthy
    end
    context "passed citation and hypothesis" do
      ...
      it "is valid" do
        ...
        expect(citation_challenge.approved?).to be_falsey
        expect(citation_challenge.hypothesis_citation).to be_present
